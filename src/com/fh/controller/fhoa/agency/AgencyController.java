package com.fh.controller.fhoa.agency;
...
import com.fh.service.fhoa.agency.AgencyManager;
...
public class AgencyController extends AcStartController {
	
	String menuUrl = "agency/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Agency");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Agency");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Agency");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Agency");
		...
		page.setPd(pd);
		List<PageData>	varList = agencyService.list(page);	//列出Agency列表
		mv.setViewName("fhoa/agency/agency_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("fhoa/agency/agency_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = agencyService.findById(pd);	//根据ID读取
		mv.setViewName("fhoa/agency/agency_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Agency");
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			agencyService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Agency到excel");
