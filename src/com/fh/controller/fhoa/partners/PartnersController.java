package com.fh.controller.fhoa.partners;
...
import com.fh.service.fhoa.partners.PartnersManager;
...
public class PartnersController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Partners");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Partners");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Partners");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Partners");
		...
		page.setPd(pd);
		List<PageData>	varList = partnersService.list(page);	//列出Partners列表
		mv.setViewName("fhoa/partners/partners_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("fhoa/partners/partners_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = partnersService.findById(pd);	//根据ID读取
		mv.setViewName("fhoa/partners/partners_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Partners");
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			partnersService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Partners到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("BANK_ACCOUNT"));	    //2
