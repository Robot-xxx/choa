package com.fh.controller.fhoa.warehouse;
...
import com.fh.service.fhoa.warehouse.WarehouseManager;
...
public class WarehouseController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		for (int i = 0; i <varList.size() ; i++) {
			varList.get(i).put("UPDATE_DATE",sd.format(varList.get(i).get("UPDATE_DATE")));
		}
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			warehouseService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).get("UPDATE_DATE").toString());	    //1
			vpd.put("var2", varOList.get(i).getString("RESPONSIBLE_PERSON"));	    //2
