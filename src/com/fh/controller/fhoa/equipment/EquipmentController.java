package com.fh.controller.fhoa.equipment;
...
import com.fh.service.fhoa.equipment.EquipmentManager;
...
public class EquipmentController extends AcStartController {
	...
	public  Map<String, Object> tijiaoFlow() throws Exception{
		...
		try {
			...
			map1.put("特种设备编号", pd.getString("SYS_ID"));
			...
			String act_id=startProcessInstanceByKeyHasVariables("t_tezhongshebeiliucheng",map1);	//启动流程实例(请假单流程)通过KEY


			pd.put("STATUS",3);
			pd.put("ACT_ID",act_id);
			pd.put("TABLENAME","oa_equipment");
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Equipment");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Equipment");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Equipment");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Equipment");
		...
		mv.setViewName("fhoa/equipment/equipment_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("fhoa/equipment/equipment_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Equipment");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Equipment到excel");
