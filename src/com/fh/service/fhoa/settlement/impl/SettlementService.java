package com.fh.service.fhoa.settlement.impl;
...
public class SettlementService implements SettlementManager{
	...
	@Override
	public PageData endById(PageData pd) throws Exception {
		return (PageData)dao.findForObject("SettlementMapper.endById", pd);
	}
