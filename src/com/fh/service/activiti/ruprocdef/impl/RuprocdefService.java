...
public class RuprocdefService implements RuprocdefManager{
    ...
    @Override
    public List<PageData> queryRenWu(PageData pd) throws Exception {
        return (List<PageData>)dao.findForList("RuprocdefMapper.queryRenWu", pd);
	}

    @Override
    public void updateParent(PageData pd) throws Exception {
        dao.update("RuprocdefMapper.updateParent", pd);
