...
(function ($) {
    ...
    $sS.fn.extend({
        init: function () {
            ...
            this.holder = $('<div id="tagNameLu" class="searchable-select-holder"></div>');
        ...
        selectItem: function (item) {
            ...
            var str = selectOption(item);
            if (str == "project") {
                g_selectOption(item);
                k_selectOption(item);
                c_selectOption(item);
            }
            if (str == "projectpurchase") {

                  selectOptionPurchase(item);
                }
