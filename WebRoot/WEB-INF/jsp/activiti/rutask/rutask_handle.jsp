												...
												<table id="table_report" class="table table-striped table-bordered table-hover">
													<tr>
														...
														<td colspan="10" id="omsg">
															<textarea hidden  name="OPINION" id="OPINION" maxlength="4000" style="height: 100px; width: 100%"  ></textarea>
                                                            ...
                                                            <table id="table_report" class="table table-striped table-bordered table-hover">
                                                                ...
                                                                <span style="color:red">注:流程见流程图,若下一个办理人为未确定部门的部门经理,则需要指定下一办理对象,其他情况下直接批准即可</span><br>
