...
<body class="no-skin">
						...
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入公司名称、联系人" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入客户序号"/>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="name" id="id" data-placeholder="请选择医疗许可证" style="vertical-align:top;width: 120px;">
									<option value=""></option>
	...
	<script type="text/javascript">
		$(top.hangge());//关闭加载状态
        function tijiao(CUSTOMER_ID,obj){
            $.ajax({
                url: "<%=basePath%>customer/tijiaoFlow.do",
