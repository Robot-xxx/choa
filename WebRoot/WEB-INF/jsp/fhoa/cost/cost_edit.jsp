				...
				<div class="row">
					...
					<form action="cost/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;"><font color="red">*</font>是否代理商付款:</td>
								...
								<td align="left" >
									是<input type="radio" name="IS_THEAGENT"  <c:if test="${pd.IS_THEAGENT==1}">checked</c:if> value="1" />
									否<input type="radio" name="IS_THEAGENT"  <c:if test="${pd.IS_THEAGENT==0}">checked</c:if>  value="0"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input name="DEPARTMENT" id="DEPARTMENT" value="${pd.DEPARTMENT}" type="text"  placeholder="部门" title="部门" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;"><font color="red">*</font>报销人:</td>
								<td><input type="text" name="BXR" readonly id="BXR" value="${pd.BXR}" maxlength="50" placeholder="这里输入报销人" title="报销人" style="width:98%;"/></td>
							</tr>
