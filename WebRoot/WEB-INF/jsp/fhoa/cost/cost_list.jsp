...
<body class="no-skin">
	...
	<script type="text/javascript">
        ...
        function tijiao(COST_ID,obj){
            $.ajax({
                url: "<%=basePath%>cost/tijiaoFlow.do",
        ...
        function allClaimexpense(COST_ID){
            ...
            diag.Drag=true;
            diag.Title ="新增";
            diag.URL = '<%=basePath%>claimexpense/list.do?COST_ID='+COST_ID;
            diag.Width = 1000;
            diag.Height = 600;
            diag.Modal = true;				//有无遮罩窗口
            diag. ShowMaxButton = true;	//最大化按钮
            ...
            diag.CancelEvent = function(){ //关闭事件
                $.ajax({
                    url: "<%=basePath%>claimexpense/getList.do",
                    data:{'COST_ID':COST_ID},
                    success: function(data){
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>cost/goAdd.do';
			 diag.Width = 800;
			 diag.Height = 600;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
