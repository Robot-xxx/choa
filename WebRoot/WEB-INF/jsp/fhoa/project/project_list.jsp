...
<body class="no-skin">
								...
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输公司名称、项目编号、项目名称" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入项目编号"/>
	...
	<script type="text/javascript">
        ...
        function tijiao(PROJECT_ID,obj){
            $.ajax({
                url: "<%=basePath%>project/tijiaoFlow.do",
