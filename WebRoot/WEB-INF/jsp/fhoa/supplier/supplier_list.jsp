...
<body class="no-skin">
								...
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入公司名称、联系人" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入供应商编号"/>
	...
	<script type="text/javascript">
		...
		function tijiao(SUPPLIER_ID,obj){

            $.ajax({
				url: "<%=basePath%>supplier/tijiaoFlow.do",
