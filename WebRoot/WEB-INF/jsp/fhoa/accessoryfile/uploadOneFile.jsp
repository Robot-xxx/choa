            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="uploadfile/${msg }.do" name="Form" id="Form" method="post">
                            ...
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="FILENAME" id="FILENAME" value="123" maxlength="30"
                                                   placeholder="这里输入文件名" title="文件名" style="width:98%;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:75px;text-align: right;padding-top: 13px;" id="FILEPATHn">文件:
                                        </td>
                                        <td>
                                            <input type="file" name="File_name" id="uploadify1"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="BZ" id="BZ" value="" maxlength="100"
    ...
    $(document).ready(function () {
        ...
        $("#uploadify1").uploadify({
            ...
            'onSelect': function (event, queueId, fileObj) {
                ...
                $("#FILENAME").val(str.substring(0, str.lastIndexOf('.')));
            },
            ...
            success: function (data) {
                ...
                $.each(data.list, function (i, dvar) {
                    if (DICTIONARIES == dvar.BIANMA) {
                        $("#DICTIONARIES").append("<option value=" + dvar.NAME + " selected='selected'>" + dvar.NAME + "</option>");
                    } else {
                        $("#DICTIONARIES").append("<option value=" + dvar.NAME + ">" + dvar.NAME + "</option>");
                    }
                });
            }
        });
