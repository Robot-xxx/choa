			...
			<div class="page-content">
				<div class="row">
					...
					<form action="uploadfile/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="FILEID" id="FILEID" value="${pd.FILEID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">文件名字:</td>
								<td><input type="text" name="FILENAME" id="FILENAME" value="${pd.FILENAME}" maxlength="255" placeholder="这里输入文件名字" title="文件名字" style="width:98%;"/></td>
							</tr>
							<tr>
